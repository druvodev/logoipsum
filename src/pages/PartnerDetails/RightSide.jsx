      ...
      <div className="mt-8">
        ...
        <div className="mt-8 flex justify-between gap-5">
          <div>
            ...
            <p className="text-xl mt-1">{about?.from}</p>
          </div>
          <div>
            <h4 className="text-secondary font-bold">PARTNER SINCE</h4>
            <p className="text-xl mt-1">{about?.partnerSince}</p>
          </div>
          <div>
            <h4 className="text-secondary font-bold">AVERAGE RESPONSE TIME</h4>
            <p className="text-xl mt-1">{about?.averageResponseTime}</p>
          </div>
        </div>
        <div className="mt-4">
          <h4 className="text-secondary font-bold">ABOUT</h4>
          <p>
            <p className="text-xl mt-1">{about?.description}</p>
          </p>
        </div>
